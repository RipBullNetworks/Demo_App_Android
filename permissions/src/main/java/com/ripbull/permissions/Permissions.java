package com.ripbull.permissions;
  ...
  private static void requestPermissions(
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      fragment.requestPermissions(
          filterNotGranted(fragment.getContext(), permissions), requestCode);
    }
  }
  ...
  private static class FragmentPermissionObject extends PermissionObject {
    ...
    public boolean hasAll(String... permissions) {
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
        ...
        return Permissions.hasAll(fragment.getActivity().getBaseContext(), permissions);
      }
    }
