package com.ripbull.coreattachment.emoji
...
constructor(
  ...
  rootView: View,
  private val emojiText: AppCompatTextView,
  private val dialogView: ConstraintLayout
) {
  ...
  private fun showForEditText(dialogView: ConstraintLayout) {
