...
constructor(
  ...
  fun setOnClickListenerHomeButton(listener: OnClickListener?) =
    homeButton.setOnClickListener(listener)

  fun setOnClickListenerBackButton(listener: OnClickListener?) =
    backButton.setOnClickListener(listener)

  fun setOnClickListenerSpaceButton(listener: OnClickListener?) =
