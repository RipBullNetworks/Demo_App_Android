 ...
 * @author Sagar
 */
class SelectMediaContactAdapter(
  private val contactList: List<UserRecord>,
  private val glide: GlideRequests,
  private val listener: SelectMediaContactAdapterListener
) : RecyclerView.Adapter<SelectMediaContactAdapter.MyViewHolder>(), Filterable {
  ...
  interface SelectMediaContactAdapterListener {
