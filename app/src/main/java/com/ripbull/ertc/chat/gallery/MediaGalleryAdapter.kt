...
class MediaGalleryAdapter(
  ...
  override fun getView(
    ...
    if (convertView == null) {
      convertView = layoutInflater!!.inflate(R.layout.item_media_gallery, null)
    }
    imageView = convertView!!.findViewById(R.id.ivMediaGallery)
    playVideo = convertView!!.findViewById(R.id.ivPlayVideo)
