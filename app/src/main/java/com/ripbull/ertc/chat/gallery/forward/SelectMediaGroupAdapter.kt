 ...
 * @author Sagar
 */
class SelectMediaGroupAdapter(
  private val groupList: ArrayList<GroupRecord>,
  private val glide: GlideRequests,
  private val listener: SelectMediaGroupAdapterListener

) : RecyclerView.Adapter<SelectMediaGroupAdapter.MyViewHolder>(), Filterable {
  ...
  interface SelectMediaGroupAdapterListener {
    fun onGroupSelected()
  }
