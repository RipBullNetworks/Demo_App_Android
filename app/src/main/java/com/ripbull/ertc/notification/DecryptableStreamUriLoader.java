...
public class DecryptableStreamUriLoader implements
    ModelLoader<DecryptableStreamUriLoader.DecryptableUri, InputStream> {
  ...
  @Nullable
  @Override
  public ModelLoader.LoadData<InputStream> buildLoadData(@NonNull DecryptableUri decryptableUri, int width, int height, @NonNull Options options) {
